class StaticPagesController < ApplicationController
  ...
  def music
    ...
    accident_url,  accident_src   = itunes_prefix + "accidental-love-letters-single/id485158289",  "accident.jpg"
    ...
    @albums = [ [accident_url,  accident_src],
                [forever_url, forever_src], [green_url,   green_src],
                [recluse_url, recluse_src], [gone_url,    gone_src]]
  end
